...
//
// Modified and adapted for the SelfBalancingScooter project 
// by Alberto Trentadue October 2017
//
// Using Arduino 1.0.1
...
{      
  ...
  */
  ...
  /** Sets digital low-pass filter configuration.
  ...
  //uint8_t cf = (c & 0xF8) | MPU6050_DLPF_21HZ;
  uint8_t cf = (c & 0xF8) | MPU6050_DLPF_5HZ;
  MPU6050_write_reg (MPU6050_CONFIG, cf);
  
}


void leggi_mpu6050(void)
{
  int error;
  double dT;
